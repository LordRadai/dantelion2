...
namespace DLMT
{
    ...
    dl_bool DL_VECTOR2::IsNormalized(dl_float32 epsilon) const
    {
        return fabsf(this->LengthSquared() - 1.0f) <= epsilon;
    }

    dl_bool DL_VECTOR2::IsZero(dl_float32 epsilon) const
    {
        return fabsf(this->x) <= epsilon && fabsf(this->y) <= epsilon;
    }

    dl_bool DL_VECTOR2::Equals(const DL_VECTOR2& other, dl_float32 epsilon) const
    {
    ...
    dl_bool DL_VECTOR2::operator==(const DL_VECTOR2& other) const
    {
        return this->x == other.x && this->y == other.y;
    }
    ...
    dl_bool DL_VECTOR3::IsNormalized(dl_float32 epsilon) const
    {
        return fabsf(this->LengthSquared() - 1.0f) <= epsilon;
    }

    dl_bool DL_VECTOR3::IsZero(dl_float32 epsilon) const
    {
        return fabsf(this->x) <= epsilon && fabsf(this->y) <= epsilon && fabsf(this->z) <= epsilon;
    }

    dl_bool DL_VECTOR3::Equals(const DL_VECTOR3& other, dl_float32 epsilon) const
    {
    ...
    dl_bool DL_VECTOR3::operator==(const DL_VECTOR3& other) const
    {
        return this->x == other.x && this->y == other.y && this->z == other.z;
    }
    ...
    dl_bool DL_VECTOR4::IsNormalized(dl_float32 epsilon) const
    {
        return fabsf(this->LengthSq() - 1.0f) <= epsilon;
    }

    dl_bool DL_VECTOR4::IsZero(dl_float32 epsilon) const
    {
        return fabsf(this->x) <= epsilon && fabsf(this->y) <= epsilon
            && fabsf(this->z) <= epsilon && fabsf(this->w) <= epsilon;
    }

    dl_bool DL_VECTOR4::Equals(const DL_VECTOR4& other, dl_float32 epsilon) const
    {
        return fabsf(this->x - other.x) <= epsilon
            && fabsf(this->y - other.y) <= epsilon
            && fabsf(this->z - other.z) <= epsilon
